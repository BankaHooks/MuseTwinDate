...
INTEREST_CATEGORIES = {
    "Активный отдых": ["Скалолазание", "Бег", "Плавание", "Йога", "Командные виды спорта", "Зимние виды спорта", "Фитнес", "Танцы", "Велопрогулки"],
    "Искусство": ["Живопись", "Фотография", "Игра на музыкальных инструментах", "Каллиграфия", "Гончарное дело", "Театр", "Литература", "Граффити"],
    "Интеллект": ["Книги", "Настольные игры", "Астрономия", "История", "Научные подкасты", "Шахматы", "Психология", "Языки"],
    "Гастрономия": ["Кофе-культура", "Виноделие", "Кулинария", "Гастрономический туризм", "Веганство", "Завтраки", "Фермерские продукты"],
    "Путешествия": ["Трекинг", "Автостоп", "Экотуризм", "Кемпинг", "Изучение городов", "Фестивальная культура"],
    "Технологии": ["Видеоигры", "Кино", "Аниме", "Подкасты", "Киберспорт", "Комиксы"],
